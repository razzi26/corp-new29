    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 relative">
          <div className="flex py-4 xl:py-6 items-center justify-between md:grid md:grid-cols-[auto_1fr_auto]">
      ...
      {open &&
        createPortal(
          <div className="fixed left-0 right-0 top-15 bottom-0 z-[60] md:hidden">
            <div
