  ...
  return (
    <div className="text-white">
      ...
      <section className="container mx-auto px-4 pt-20 md:pt-28">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-white/85 text-base md:text-lg max-w-prose">
            ...
            <p className="mt-3 text-white/85 text-base md:text-lg max-w-prose">
            ...
            <div className="mt-6 flex gap-3">
              <Link to="/contact" className="inline-flex items-center justify-center rounded-lg bg-white text-[hsl(var(--brand-end))] px-5 py-3 font-semibold shadow hover:shadow-md transition">
                Contact us
              </Link>
              <Link to="/blog" className="inline-flex items-center justify-center rounded-lg border border-white/30 px-5 py-3 font-semibold hover:bg-white/10 transition">
                Explore resources
              </Link>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="relative rounded-3xl border border-white/20 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-xl p-6 md:p-8 shadow-2xl">
              ...
              <ul className="mt-4 space-y-3 text-white/85 text-sm leading-relaxed">
      ...
      <section className="container mx-auto px-4 mt-20 mb-24">
        <div className="rounded-2xl border border-white/20 bg-white/5 backdrop-blur p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
          ...
          <div className="flex gap-3">
            <Link to="/contact" className="inline-flex items-center rounded-lg bg-white text-[hsl(var(--brand-end))] px-5 py-3 font-semibold shadow hover:shadow-md transition">
              Get in touch
            </Link>
            <Link to="/catalog" className="inline-flex items-center rounded-lg border border-white/30 px-5 py-3 font-semibold hover:bg-white/10 transition">
              Browse products
            </Link>
          </div>
        </div>
