    ...
    <div id="top" className="text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-white/85 text-base md:text-lg max-w-xl">
              Turnkey supply, implementation and service support. From patient monitors to laboratory diagnostics — on time and within budget.
            </p>

            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <Link to="/catalog" className="inline-flex items-center justify-center rounded-lg bg-white text-[hsl(var(--brand-end))] px-5 py-3 font-semibold shadow hover:shadow-md transition">
                Explore catalog
              </Link>
              <Link to="/contact" className="inline-flex items-center justify-center rounded-lg border border-white/30 px-5 py-3 font-semibold hover:bg-white/10 transition">
                Get consultation
              </Link>
            </div>
      ...
      <section className="container mx-auto px-4 mt-20">
        <div className="flex items-end justify-between gap-4">
          ...
          <Link to="/contact" className="hidden md:inline-flex text-sm hover:underline">Need help choosing?</Link>
        </div>
        ...
        <div className="mt-6">
          <Link to="/catalog" className="inline-flex items-center rounded-lg bg-white text-[hsl(var(--brand-end))] px-5 py-3 font-semibold shadow hover:shadow-md transition">View full catalog</Link>
        </div>
      </section>
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-white/20 bg-white/5 backdrop-blur">
      ...
      <div className="p-5">
        ...
        <p className="mt-1 text-sm text-white/80">Check availability and pricing with our manager</p>
        <div className="mt-4 flex gap-2">
          <Link to="/contact" className="inline-flex items-center rounded-lg bg-white text-[hsl(var(--brand-end))] px-3 py-2 text-sm font-semibold shadow">
            Request quote
          </Link>
          <Link to="/contact" className="inline-flex items-center rounded-lg border border-white/30 px-3 py-2 text-sm font-semibold hover:bg-white/10">
            Consultation
          </Link>
        </div>
      </div>
